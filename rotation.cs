...
private void InitializeCustomLUAFunctions()
        {
            ...
            CustomFunctions.Add("CooldownsToggleCheck", "local loading, finished = C_AddOns.IsAddOnLoaded(\"Hekili\") if loading == true and finished == true then local cooldowns = Hekili:GetToggleState(\"cooldowns\") if cooldowns == true then return 1 else if cooldowns == false then return 2 end end end return 0");
